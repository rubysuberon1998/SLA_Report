<html>
<head><center><h1>TRACKER</h1></center>
  <Title>DATAMATICS TRACKER </Title>
...
<nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="navbar-brand">
            <span class="navbar-logo">
                <a href="https://index.php">
                     <img src="assets/images/finallogo-81x87.png" alt="Mobirise" title="" class="height: 3.8rem;">
                </a>
            </span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
          <li class="nav-item affixnav-link link text-white display-4"></li>

            <li class="nav-item">
                <a class="nav-link link text-white display-4" href="http://rjslalocal.ph/"><span class="mbri-sites mbr-iconfont mbr-iconfont-btn"></span>
                Dashboard &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</a>
            </li>
             ...
             <li class="nav-item">
             <a class="nav-link link text-white display-4" href="/solved-issues/" aria-expanded="true"><span class="mbri-preview mbr-iconfont mbr-iconfont-btn"  id="tickets"></span>
              Solved Issues &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</a>
            </li>
...
<tr>
  ...
  <td>
   <b>Year:</b> <input type="text" name="Year" class="select" required value="<?php echo $yeartoday;?>">
 
  </td>
 
  <td>
      <b>Month:</b><select type="text" name='month' id='month' class="select" value="" onClick="getMonth()">
...
<tr>
    ...
    ?>
   <td>
  <b>Week:</b> <select name="week" class="select" id="week" onClick="">
  <option value="" selected disabled hidden>--Select--</option>
  </select>
  </td>

    <td>
      <b>Day:</style></b> <input type="text" name="day" class="select" id="day" value="<?php echo $daytoday?>"><br>
